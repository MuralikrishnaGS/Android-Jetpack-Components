...
class AlertDialogManager {
    ...
    fun createDialogWithOneBtn(context: Context, title: String, message: String) {
    ...
    fun createDialogWithOneBtn(
        ...
        Log.d(
            TAG,
            "create one button dialog with title: $title message: $message button text:$positiveBtnText title accessibility text:$titleContentDescription message accessibility text:$messageContentDescription"
        )
        createDialog(
            context,
            title,
    ...
    fun createDialogWithTwoBtns(
        ...
        Log.d(
            TAG,
            "create two buttons dialog with title: $title message: $message button text:$positiveBtnText,$negativeBtnText"
        )
        createDialog(
            context,
            title,
    ...
    private fun setAccessibilityText(context: Context, title: String?, message: String?) {
        if (title != null) {
            val alertTitle = context.resources.getIdentifier("alertTitle", "id", "android")
